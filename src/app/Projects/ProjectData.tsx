...
export interface IProjectList {
  ...
  projects.set("PanjatPinang", {
    ...
    desc: (
      <div>
        <p className="text-justify">
          One of my Unity-based game inspired by Panjat Pinang and <a href="https://www.online-stopwatch.com/duck-race/" class="text-slate-50">Duck Race</a>. Panjat Pinang is a traditional Indonesian activity celebrated during Indonesia&apos;s Independence Day. in the game participants climb a slippery pole and claim prizes. I developed this project to not only commemorate the national holiday but also to showcase the potential of integrating cultural heritage with interactive digital experiences.
        </p>
